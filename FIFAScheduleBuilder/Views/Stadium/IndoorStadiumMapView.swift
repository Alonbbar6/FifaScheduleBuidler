...
struct IndoorStadiumMapView: View {
            ...
            HStack(spacing: 12) {
                ForEach([1, 2, 3], id: \.self) { level in
                    Button {
                        ...
                        .background(selectedLevel == level ? Color.orange : Color(.systemGray6))
    ...
    private var sectionsView: some View {
        ZStack {
            ...
            ForEach(stadiumData.allSections.filter { $0.level == selectedLevel }, id: \.id) { section in
                SectionView(section: section, isSelected: false)
    ...
    private var userLocationMarker: some View {
        ...
        .position(x: 900, y: 900) // Centered in stadium
    }
...
struct SectionView: View {
    ...
    var sectionColor: Color {
        ...
        case "premium":
            return Color(red: 0.65, green: 0.2, blue: 0.8) // Vibrant purple
        case "club":
            return Color(red: 0.15, green: 0.4, blue: 0.95) // Bright blue
        case "general", "standard":
            return Color(red: 0.5, green: 0.52, blue: 0.56) // Medium gray
        default:
            return Color.gray
        }
    }
