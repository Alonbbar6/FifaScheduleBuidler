            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        ForEach(WorldCupGame.mockGames.prefix(2)) { game in
...
struct ModularTicketsView: View {
    @State private var selectedGame: WorldCupGame?
...
struct PremiumUnlockCard: View {
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Get real-time updates, AR navigation, and AI assistance for just $2.99")
                .font(.subheadline)
                .foregroundColor(.secondary)
